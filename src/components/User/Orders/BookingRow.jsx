...
const BookingRow = ({ booking, receiptClicked }) => {
    ...
    <React.Fragment>
      <tr class=" w-full rounded">
        ...
        <td class="whitespace-no-wrap py-4 text-sm font-normal text-gray-500 sm:px-3 lg:table-cell">
          <span class="ml-2 w-12 mr-6 whitespace-nowrap rounded-full bg-green-100 px-2 py-0.5 text-green-800">
