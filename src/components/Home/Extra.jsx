    ...
    <React.Fragment>
      <section class="bg-white py-12 text-gray-700 sm:py-16 lg:py-20">
        <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="mt-10 grid grid-cols-2 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-12">
            <article class="relative border p-2 rounded cursor-pointer">
              <div class="aspect-square rounded overflow-hidden">
                <img
                  class="group-hover:scale-125 hover:scale-105 h-full w-full object-cover transition-all duration-300"
            ...
            <article class="relative border p-2 rounded cursor-pointer">
              <div class="aspect-square cursor-pointer rounded overflow-hidden">
                <img
                  class="group-hover:scale-125 hover:scale-105  h-full w-full object-cover transition-all duration-300"
                  src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                  alt=""
            ...
            <article class="relative border p-2 rounded cursor-pointer">
              <div class="aspect-square rounded overflow-hidden cursor-pointer">
                <img
                  class="group-hover:scale-125 hover:scale-105  h-full w-full object-cover transition-all duration-300"
                  src="https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                  alt=""
