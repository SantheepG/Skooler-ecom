...
const SearchSuggestions = () => {
  return (
    <React.Fragment>
      <div
        class="SlideDown absolute overflow-hidden z-50 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700"
